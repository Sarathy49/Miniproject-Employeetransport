...
//    private static final String DB_URL = "jdbc:mysql://127.0.0.1:3306/employ_transport";
	private static final String DB_URL = "jdbc:mysql://127.0.0.1:3306/employ_transport?useSSL=false&requireSSL=false";

    private static final String DB_USER = "root";
    private static final String DB_PASSWORD = "Sara@2003";
    static {
        try {
    ...
    private Vehicle getVehicleById(int vehicleId) {
        ...
        try (Connection conn = getConnection();
             PreparedStatement pstmt = conn.prepareStatement("SELECT * FROM vehicles WHERE vehicle_id = ?")) {
